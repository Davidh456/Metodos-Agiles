 ...
 * @author lucas
 */
public class ExisteReservaTest3 {
    
    public ExisteReservaTest3() {
    }
    ...
    public void setUp() throws IOException, DocumentException {
        ...
        Cliente cli2 = ABMCliente.getInstance().listarClientes().get(2);
        myCal.set(Calendar.YEAR, 2016);
    ...
    @Test
    public void ExisteReservaCP3(){
        //Verificar si existe reserva para un inmueble que posee reservas antiguas
