...
public class Cliente  implements java.io.Serializable {
    ...
    public Cliente(Localidad localidad, Provincia provincia, String nombre, String apellido, int tipoDoc, int numeroDoc, String domicilio, int alturaDomicilio, int telefono, String correo, Boolean esPropietario) {
       this.localidad = localidad;
       this.provincia = provincia;
       this.nombre = nombre;
       this.apellido = apellido;
