...
public class Propietario  implements java.io.Serializable {
    ...
    public Propietario(Localidad localidad, Provincia provincia, String nombre, String apellido, int tipoDoc, int numeroDoc, String domicilio, int alturaDomicilio, int telefono, String correo, Set inmuebles) {
       this.localidad = localidad;
       this.provincia = provincia;
       this.nombre = nombre;
       this.apellido = apellido;
