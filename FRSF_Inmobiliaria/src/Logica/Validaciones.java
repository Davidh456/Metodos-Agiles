		...
		tf.addKeyListener(new KeyListener(){
			public void keyTyped(KeyEvent e){
			    ...
			    if( !(((caracter >= 'A')&&(caracter <= 'z'))||caracter==127||caracter==8||caracter==32)&& tipo.equals("alfabetico")){
			    	JOptionPane.showMessageDialog(null, "S�lo se pueden ingresar letras","�CUIDADO!",JOptionPane.ERROR_MESSAGE);
			    	e.consume();
			    }
				
				//que no sea n�mero
				if(!(((caracter >= '0')&&(caracter <= '9'))||caracter==127||caracter==8||caracter==32) && tipo.equals("numerico")){
					JOptionPane.showMessageDialog(null, "S�lo se pueden ingresar n�meros","�CUIDADO!",JOptionPane.ERROR_MESSAGE);
			    	e.consume();
			    }
			}
