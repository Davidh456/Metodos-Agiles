...
public class AltaClienteOPropietario extends javax.swing.JPanel {
    ...
    public AltaClienteOPropietario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tfNombre.setText("Nombre del vendedor");

        tfApellido.setText("Apellido del vendedor");

        tfNumeroDocumento.setText("12345678");
        ...
        jTextField2.setText("correo@electronico.com");
